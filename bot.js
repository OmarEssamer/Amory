          ...
          .then(co => {
            text = co.first().content
              ...
              message.channel.send(`تم حفظ اقتراحك الرجاء انتضار الرد من قبل الاداره`)
                client.channels.get("491668935947714568").send(`${message.author.username}'s sug => ${text}`)
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=548516883264176130&permissions=0&scope=bot')
  .setDescription(`**
  Someone Added Me ✅
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("491668935947714568").sendEmbed(embed)
});
...
:checkered_flag: تاريخ انضمامك للسيرفر ${member.joinedAt.toLocaleString()} :checkered_flag:`) 
  ...
  client.on('message',async message => {
    if(message.content.startsWith(prefix + "restart")) {
        if(message.author.id !== "491668935947714568") return message.reply('You aren\'t the bot owner.');
...
if (message.content.startsWith(prefix + 'trans')) {
  ...
  .setColor("#9B59B6")
  .addField(" ** :scales:سيرفر الدعم:scales:  **" , "  **https://discord.gg/Fewz4j6**")
...
client.on('message', message => {
                if(message.content === prefix + "invite") {
                  ...
                  .setFooter(`Frazza Bot `,'https://cdn.discordapp.com/attachments/457004554869932033/471106003249659914/image.jpg')
                  .setURL("https://goo.gl/X8vish");
                   message.channel.sendEmbed(embed);
                  }
});
